 ...
 * Author: aless
 *
 * Created on January 28, 2020, 5:57 PM
 */

/*
 * AL TERMINE DELLA PRESSIONE DEL PULSANTE, CAMBIARE LO
 * STATO DEL LED E INVIARE TRAMITE SERIALE IL VALORE DEL
 * POTENZIOMETRO CAMPIONATO DALL?ADC ALLA FREQUENZA DI 10 Hz
 */
...
void set_port(void){
    ...
    // BUTTON
    PORTC |= (1<<PORTC5);           // SET PC5 A PULL-UP
